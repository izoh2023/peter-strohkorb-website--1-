...
export function Plugins({}) {
  ...
  return (
    <div className="relative">
      <ToolbarPlugin>
        {({ blockType }) => (
          <div className="sticky top-0 z-10 flex flex-wrap items-center gap-2 overflow-x-auto border-b p-1 bg-background">            <HistoryToolbarPlugin />
            ...
            <div className="">
              <div className="" ref={onRef}>
                <ContentEditable
                  ...
                  className="ContentEditable__root relative block min-h-72 sm:min-h-[400px] lg:min-h-[500px] xl:min-h-[600px] h-[calc(100vh-300px)] overflow-auto px-4 sm:px-6 md:px-8 py-4 focus:outline-none"                />
              </div>
            </div>
          }
      ...
      <ActionsPlugin>
        <div className="clear-both flex flex-wrap items-center justify-between gap-2 overflow-x-auto border-t p-2">
